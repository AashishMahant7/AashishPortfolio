...
function Contact() {
    const [state, sendData] = useForm("mvoejwrw");
                ...
                <div className="contact-container">
                    <div className="left">
                        ...
                        <div className="contact-detail">
                            <h3>Address</h3>
                            <p className='pointers'>Ghaziabad, uttar pradesh</p>
                        </div>
                        <div className="contact-detail">
                            <h3>Phone No.</h3>
                            <a className='pointers' href='tel:+919732224977'>+919315339040</a>
                        </div>
                        <div className="contact-detail">
                            <h3>Email</h3>
                            <a className='pointers' href='mailto:aashishmahant15102002@gmail.com'>aashishmahant15102002@gmail.com</a>
                        </div>
                    </div>
                    <div className="right">
                        <form
                        ...
                        >
                            { <input value="aashishmahant15102002@gmail.com" type="hidden" name="_replyto" /> }
